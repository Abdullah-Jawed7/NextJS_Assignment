...
export default function name({params}:{params:{
    ...
    let content = data.find((item)=>String(item.id)== params.product[0])
    if (content) pro=content;
return(
    <div className="bg-[#f0f8ff] py-8 sm:p-8 md:px-30 lg:px-52">
        <div>
            ...
            <h3 className="text-[#3eb549] text-2xl my-6 text-center ">PKR {pro?.ask}</h3>
                           
            </div>
            <div id="payment" className="text-center">
               <Link href={`/${params.product}/thanks`}>
